...
const [income2, setIncome2] = useState([]);
  ...
  const fetchInvoice = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get('https://api-sme.promixaccounting.com/api/v1/income/fetch-all', { headers });
  ...
  const fetchIncome1 = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get('https://api-sme.promixaccounting.com/api/v1/income/total-lodged', { headers });
      const total1 = response.data?.data;
  ...
  const fetchIncome2 = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get('https://api-sme.promixaccounting.com/api/v1/income/total-pending-lodge', { headers });
      const total2 = response.data?.data;
  ...
  const handlePrintInvoice = (id) => {
    const selectedIncome = tableData.find(item => item.id === id);
  
  
    navigate('/print_off_receipt', { state: { selectedIncome } });
  };
              ...
              <div className="col-sm-8 header-title p-0">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h1 className="font-weight-bold">Receipt</h1>
                    <small>Add income and view your receipt...</small>
                  </div>
                </div>
              </div>
            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <p class="text-muted fs-13 mb-0">Total Lodge</p>
                                                    <h3 class="mb-2 fw-semibold" style={{textAlign: "right", marginTop: 10}}>
                                                    ₦{parseFloat(income1).toLocaleString('en-US', {
                                      minimumIntegerDigits: 1,
                                      minimumFractionDigits: 2,
                                      maximumFractionDigits: 2
                                    })}</h3>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <p class="text-muted fs-13 mb-0">Total Outstanding</p>
                                                    <h3 class="mb-2 fw-semibold" style={{textAlign: "right", marginTop: 10}}>
                                                    ₦{parseFloat(income2).toLocaleString('en-US', {
                                      minimumIntegerDigits: 1,
                                      minimumFractionDigits: 2,
                                      maximumFractionDigits: 2
                                    })}</h3>
