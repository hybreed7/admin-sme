...
import classes from './GrantApprovals.module.css';
...
const navigate = useNavigate();
  ...
  const fetchLoans = async () => {
    ...
    try {
      const response = await axios.get('https://api-smesupport.ogunstate.gov.ng/api/approved-grants', { headers });
              ...
              <div className="col-sm-8 header-title p-0">
                <div className="media">
                  ...
                  <div className="media-body" >
                    <h1 className="font-weight-bold">Grant Application Approvals</h1>
