                  ...
                  <div className="col-sm-8 header-title p-0">
                    <div className="media">
                      ...
                      <div className="media-body" style={{ display: 'flex', justifyContent: "space-between", alignItems: "center" }}>
                        <div>
                          <h1 className="font-weight-bold">View Loan Application</h1>
                          <small> ....</small>
                        </div>
                              ...
                              <div className="col-md-6">
                                  <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                      <input className="form-control" required="" type="date" disabled name="date" value={selectedLoan.transaction_date} />
                                    </div>
                                  </div>
                                </div>
...
export default EditLoanAdvance;