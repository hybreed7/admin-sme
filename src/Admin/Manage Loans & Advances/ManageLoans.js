...
import classes from './ManageLoans.module.css';
...
navigate('/edit_loan_advance', { state: { selectedLoan: foundLoan } });
    setEyeClicked(true);
  };
              ...
              <div className="col-sm-8 header-title p-0">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h1 className="font-weight-bold">Loans & Advances</h1>
                    <small>Create and view your loans...</small>
                  </div>
                </div>
              </div>
            </div>
