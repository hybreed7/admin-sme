                                        ...
                                        <div class="row"><div class="col-sm-12"><table id="datatable-buttons" data-page-length="200" class="table table-bordered dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style={{width: '991px' }}>
                                            ...
                                            <tbody>
                                                ...
                                                <tr className="odd">
                                                    ...
                                                    <td>
                                                        <a className="btn-sm btn-success" href="https://patna.ng/income/payment/voucher/voucher_details/1" data-bs-toggle="tooltip" title="" data-id="1" data-bs-original-title="View voucher detail" aria-label="View voucher detail"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a className="btn-sm btn-success" href="https://patna.ng/income/payment/voucher/voucher_details/2" data-bs-toggle="tooltip" title="" data-id="2" data-bs-original-title="View voucher detail" aria-label="View voucher detail"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                </tr><tr className="odd">
                                                    ...
                                                    <td>
                                                        <a class="btn-sm btn-success" href="https://patna.ng/income/payment/voucher/voucher_details/30" data-bs-toggle="tooltip" title="" data-id="30" data-bs-original-title="View voucher detail" aria-label="View voucher detail"><i class="fa fa-eye"></i></a>
                                                    </td>
                                                </tr></tbody>
