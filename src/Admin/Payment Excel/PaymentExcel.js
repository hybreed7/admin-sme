...
import classes from "./PaymentExcel.module.css"
...
<div className='newWidth'>
            ...
            <div className="content-header row align-items-center m-0">
              ...
              <nav aria-label="breadcrumb" className="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
                ...
                >
                  <a href="https://patna.ng/income/payment/download-journal-posting/xlsx" download>
              ...
              <div className="col-sm-8 header-title p-0">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h1 className="font-weight-bold">Payment Excel Upload</h1>
                    <small>Upload your payment...</small>
                  </div>
                </div>
              </div>
            </div>
