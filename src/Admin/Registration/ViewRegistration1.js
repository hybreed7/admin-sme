...
<div style={{marginTop: 30}} />
                  <div className="col-sm-12 header-title p-0">
                    <div className="media">
                      ...
                      <div className="media-body" style={{ display: 'flex', justifyContent: "space-between", alignItems: "center" }}>
                        <div>
                          <h1 className="font-weight-bold">Details of {selectedApplicant[0].name} </h1>
    ...
    <tbody>
      <tr>
        ...
        <td style={{textAlign: "left"}}>{selectedApplicant[0].name}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Email Address</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].email}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Phone Number</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].phone_number}</td>
      </tr>
      ...
      <tr>
        ...
        <td style={{textAlign: "left"}}>{selectedApplicant[0].permanent_address}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Marital Status</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].marital_status}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Local Government</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].localgovt?.name}</td>
      </tr>
    </tbody>
  </table>
  </div>
    ...
    <tbody>
      <tr>
        ...
        <td style={{textAlign: "left"}}>{selectedApplicant[0].company_name}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Business Address</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].business_address}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Business Rc Number</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].rc_number}</td>
      </tr>
      ...
      <tr>
        ...
        <td style={{textAlign: "left"}}>{selectedApplicant[0].sector}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Marital Status</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].marital_status}</td>
      ...
      <tr>
        ...
        <td style={{textAlign: "left"}}>{selectedApplicant[0].stin}</td>
      </tr>
      <tr>
  ...
  <Accordion.Body>
  {(selectedApplicant[0]?.bank_statement || selectedApplicant[0]?.bank_statement_loan) ? (
    <>
      {selectedApplicant[0]?.bank_statement && (
        <iframe
          title={selectedApplicant[0]?.bank_statement}
          src={selectedApplicant[0]?.bank_statement}
          style={{ width: '100%', height: '500px', border: 'none' }}
        />
      )}
      {selectedApplicant[0]?.bank_statement_loan && (
        <iframe
          title={selectedApplicant[0]?.bank_statement_loan}
          src={selectedApplicant[0]?.bank_statement_loan}
          style={{ width: '100%', height: '500px', border: 'none' }}
        />
      )}
    </>
...
<Accordion.Item eventKey="3">
    ...
    <tbody>
      <tr>
        ...
        <td style={{textAlign: "left"}}>{selectedApplicant[0].bank_name}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Account Number</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].account_number}</td>
      </tr>
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>Account Name</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].account_name}</td>
      </tr>
      
     
      <tr>
        <td style={{fontWeight: "bold", textAlign: "left"}}>BVN</td>
        <td style={{textAlign: "left"}}>{selectedApplicant[0].bvn}</td>
      </tr>
    </tbody>
  </table>
  </div>
...
export default ViewRegistration1;