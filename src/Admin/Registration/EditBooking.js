...
//   console.log(selectedBooking?.asset_account, "meee");
                  ...
                  <div className="col-sm-8 header-title p-0">
                    <div className="media">
                      ...
                      <div className="media-body" style={{ display: 'flex', justifyContent: "space-between", alignItems: "center" }}>
                        <div>
                          <h1 className="font-weight-bold">Edit Booking </h1>
                              ...
                              <div className="row">
                                <div className="col-md-6">
                                  <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                      <input className="form-control" required="" type="text" value={selectedBooking?.particulars} onChange={(e) => setParticulars(e.target.value)} name="particulars" />
                                    </div>
                                  </div>
                                </div>
                                <div className="col-md-6">
                                ...
                                <div className="col-md-6">
                                  <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                      <input className="form-control" required="" type="time" onChange={handleTimeChange} name="time" value={selectedBooking?.start_hour} />
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="col-md-6">
                                  <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                      <input className="form-control" required="" type="time" onChange={handleTimeChange1} name="time" value={selectedBooking?.end_hour} />
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                      ...
                                      <CurrencyInput
                                        ...
                                        decimalsLimit={2}
                                        className="form-control"
                                        value={selectedBooking?.amount} // Set the value to the balance state
                                ...
                                <div className="col-md-6">
                                  <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                    <Form.Select name="customer" className="form-control" required="" value={selectedBooking?.income_account} onChange={handleServiceChange}>
                                            ...
                                            {item.gl_name}
                                                                ...
                                                                <div className="col-md-6">
                                                                    <div className="form-group row">
                                                                        ...
                                                                        <div className="col-sm-9">
                                                                            <Form.Select name="customer" className="form-control" required="" value={selectedBooking?.booking_account} onChange={handleAssetChange}>
                                ...
                                <div className="col-md-6">
                                  <div className="form-group row">
                                    ...
                                    <div className="col-sm-9">
                                    <Form.Select name="customer" className="form-control" required="" value={selectedBooking?.asset_account} onChange={handleAccountChange}>
