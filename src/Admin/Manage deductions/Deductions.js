...
function Deductions() {
  ...
  const fetchStep = async () => {
    setIsLoading(true);
    try {
      const response = await axios.get('https://payroll.patna.ng/api/admin/deduction/type', { headers });
      const results = response.data?.data?.deductionTypes;
