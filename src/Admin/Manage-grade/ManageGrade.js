...
import classes from './ManageGrade.module.css'; 
...
function ManageGrade() {
  ...
  const createGrade = async () => {
    ...
    try {
      const response = await axios.post(
        'https://payroll.patna.ng/api/admin/grade/create',
        { description: grade },
        { headers }
      );
      fetchGrades();
  ...
  const handleEyeClick = (id) => {
    ...
    const foundGrade = tableData.find(item => item.id === id);
    setSelectedGrade(foundGrade);
    setGrade1(foundGrade?.description || '');
    setShow1(true);
    setEyeClicked(true);
  };
  ...
  const handleTrashClick = async (id) => {
    try {
      const response = await axios.get(`https://payroll.patna.ng/api/admin/grade/delete?id=${id}`, { headers });
      fetchGrades();
      Swal.fire({
        icon: 'success',
        title: 'Success',
  ...
  const editGrade = async () => {
    ...
    try {
      const response = await axios.post(
        'https://payroll.patna.ng/api/admin/grade/update',
        {
          id: selectedGrade.id,
          description: grade1,
        },
              ...
              <div className="col-sm-8 header-title p-0">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h1 className="font-weight-bold">Manage Grades</h1>
                    <small>Create and update your grades...</small>
                  </div>
                </div>
              </div>
            </div>
                ...
                <Modal show={show} animation={false}>
                  ...
                  <Modal.Footer>
                    ...
                    {loading ? (
                      <>
                      <Spinner  size='sm' /> 
                      <span style={{ marginLeft: '5px' }}>Creating grade, Please wait...</span>
    </>
  ) : (
                "Create Grade"
                      )}
                  ...
                  <div className="card">
                    <div className="card-header">
                      <div className="d-flex justify-content-between align-items-center">
                        <div>
                          <h6 className="fs-17 font-weight-600 mb-0">All Grades</h6>
                        </div>
  ...
  <div style={{ display: 'flex' }}>
    ...
    >
      Next
                      ...
                      <>
                      <Spinner  size='sm' /> 
                      <span style={{ marginLeft: '5px' }}>Updating grade, Please wait...</span>
    </>
  ) : (
                "Update Grade"
                      )}
