...
import classes from '../../Admin/Process-CashBook/ProcessCashBook.module.css';
...
export default function ProcessCashBook() {
        ...
        <div className='newBody'>
            <div className='newWidth'>
                ...
                <p style={{width: "100%", fontSize: 18}}>{company}</p>
                    ...
                    <h6>CASHBOOK REPORT BETWEEN {formatDate(startDate)}  AND {formatDate(endDate)} OF {accountNames[0]} </h6>
                </div>
                    <p>{currentDateTime} </p>        
