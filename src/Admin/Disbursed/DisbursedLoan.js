...
import classes from './DisbursedLoan.module.css';
...
const navigate = useNavigate();
  ...
  const fetchLoans = async () => {
    ...
    try {
      const response = await axios.get('https://api-smesupport.ogunstate.gov.ng/api/disbursed-loans', { headers });
  ...
  const totalApplications = applications.filter(item => item.type === 1).length;
const pendingApplications = applications.filter(item => item.type === 1 && item.status === "Pending").length;
const approvedApplications = applications.filter(item => item.type === 1 && item.approval_status === "Approved").length;
              ...
              <div className="col-sm-8 header-title p-0">
                <div className="media">
                  ...
                  <div className="media-body" >
                    <h1 className="font-weight-bold">Loan Disbursed</h1>
                  ...
                  <div className="card">
                    <div className="card-body">
                      <div className="table-resposive">
                        ...
                        {applicationsLoading ? (
                          <p>Fetching all disbursed loans...</p>
                        ) : (
