                                    ...
                                    <div className="col-sm-12 header-title p-0">
                                        <div className="media">
                                            ...
                                            <div className="media-body" style={{ display: 'flex', justifyContent: "space-between", alignItems: "center" }}>
                                                <div>
                                                    <h1 className="font-weight-bold">Create New Sales Invoice </h1>
                                                                ...
                                                                <div className="col-md-6">
                                                                    <div className="form-group row">
                                                                        ...
                                                                        <div className="col-sm-9">
                                                                            <Form.Select name="customer" className="form-control" required="" value={selectedCustomer} onChange={handleCustomerChange} style={{width: '400px',}}>
                                                                ...
                                                                <div className="col-md-6">
                                                                    <div className="form-group row">
                                                                        ...
                                                                        <div className="col-sm-6">
                                                                            <input className="form-control" required="" type="text" readOnly value={sICode}  name="invoice" style={{width: '500px', paddingRight: '-25rem'}} />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div className="col-md-6">
