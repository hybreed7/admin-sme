...
import classes from '../../Admin/Sales-invoice/PrintInvoice.module.css';
      ...
      <div class="content-header row align-items-center m-0 " style={{cursor: "pointer"}}>
        <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
          <div className={classes.cardFooter} style={{marginBottom: 30, }}>
            <Button variant='success' onClick={handlePrint}><span className="fa fa-print dfont"> Print Invoice</span></Button>
