...
const [selectedItem,setSelectedItem] = useState(null);
  ...
  const createItems = async () => {
    ...
    try {
      const response = await axios.post(
        'https://api-sme.promixaccounting.com/api/v1/items/add-new-item',
        {
          name: name,
 ...
 const handleGlChange1 = (event) =>{
  ...
  const handleTrashClick = async (id) => {
    try {
      const response = await axios.get(`https://api-sme.promixaccounting.com/api/v1/items/delete-item?id=${id}`, { headers });
      fetchItems();
      Swal.fire({
        icon: 'success',
        title: 'Success',
  ...
  const editItems = async () => {
    ...
    try {
      const response = await axios.post(
        'https://api-sme.promixaccounting.com/api/v1/items/update-item',
        {
          name: name1,
              ...
              <div className="col-sm-8 header-title p-0">
                <div className="media">
                  ...
                  <div className="media-body">
                    <h1 className="font-weight-bold">My Stocks</h1>
                    <small>Create and view your stocks...</small>
                  </div>
                </div>
              </div>
            </div>
...
<div style={{ marginTop: 10 }} />
                      ...
                      <Modal.Footer>
                        ...
                        <Button variant="success" onClick={createItems}>
                    {loading ? (
                      <>
                      <Spinner  size='sm' /> 
