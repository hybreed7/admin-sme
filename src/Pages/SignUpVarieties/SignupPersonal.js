...
import classes from '../../Pages/SignUpVarieties/SignupPersonal.module.css';
                ...
                <div className={classes.signupbody}>
                    <div className={classes.theinputs}>
                        ...
                        <div className={classes.inputfield}>
                            ...
                            <input type="number" className={classes.myinput} placeholder="Enter email" />
                        </div>
                        <div className={classes.inputfield}>
                            <label htmlFor="myInput" className={classes.label}>Phone number</label> <br></br>
                            <input type="text" className={classes.myinput} placeholder="Enter company name" />
                        </div>
                        <div className={classes.inputfield}>
                            <label htmlFor="myInput" className={classes.label}>Address</label> <br></br>
                            <input type="text" className={classes.myinput} placeholder="Enter your password" />
                    ...
                    <div className={classes.theinputs} style={inlineStyles} >
                        <div className={classes.inputfield}>
                            <div className={classes.inputfield}>
                                ...
                                <input type="number" className={classes.myinput} placeholder="Enter Company Number" />
                            </div>

                            <div className={classes.inputfield}>
                                <label htmlFor="myInput" className={classes.label}>Company Email</label> <br></br>
                                <input type="email" className={classes.myinput} placeholder="Enter company name" />
                            </div>
                            <div className={classes.inputfield}>
                                <label htmlFor="myInput" className={classes.label}>Company Phone</label> <br></br>
                                <input type="text" className={classes.myinput} placeholder="Enter company phone" />
                            </div>
                            <div className={classes.inputfield}>
